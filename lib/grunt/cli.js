...
import ext_gruntknownoptions_gruntOptions from "grunt-known-options";
'use strict';

var encapsulated_cli;

// This is only executed when run via command line.
var cli = encapsulated_cli = function(options, done) {
  ...
  // Run tasks.
  grunt_gruntjs.tasks(cli.tasks, cli.options, done);
};

// Default options.
var optlist = cli.optlist = ext_gruntknownoptions_gruntOptions;
...
var parsed = ext_nopt_nopt(known, aliases, process.argv, 2);
